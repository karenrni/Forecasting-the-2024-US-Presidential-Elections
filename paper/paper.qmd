...
This study joins the growing body of forecast models—including media outlets’ own polls-of-polls approaches and various Bayesian methods—by refining the aggregation of poll data with logistic regression, weighted by sample size and pollster rating [@NYTimes2024_ElectionPolls; @AP2024_ElectionForecasts]. In an environment where neither candidate shows a decisive lead, this model aims to add precision by filtering out lower-quality polls, improving forecast reliability for strategic decision-making and public confidence in election projections [@Bloomberg2024_KeyStates].
